package org.copydays.web.mvc;

import org.apache.commons.lang.StringUtils;
import org.copydays.web.mvc.controller.Controller;
import org.copydays.web.mvc.controller.PageController;
import org.copydays.web.mvc.controller.RestController;
...
public class FrontControllerServlet extends HttpServlet {
    ...
    private Set<String> findSupportedHttpMethods(Method method) {
        ...
        if (supportedHttpMethods.isEmpty()) {
            supportedHttpMethods.addAll(asList(HttpMethod.GET,
                    HttpMethod.POST,
                    HttpMethod.PUT,
                    HttpMethod.DELETE,
                    HttpMethod.HEAD,
            ...
            try {
                if (handlerMethodInfo != null) {
                    ...
                    if (!handlerMethodInfo.getSupportedHttpMethods().contains(httpMethod)) {
                        // HTTP 方法不支持
                        response.setStatus(HttpServletResponse.SC_METHOD_NOT_ALLOWED); // 405 SC （Status code）
                        return;
                    }
